 ...
 * 在此基础上再基于路径压缩修改，修改find操作变慢，提升find的性能
 * 并在此基础上进行路径压缩
 * find 时使路径上的所有节点都指向根节点，从而降低树的高度。
 *
 * @author 南顾北衫
 * @email 17674641491@163.com
 */
public class UnionFindQU_Rank_PathCompression implements UnionFind {
    private int[] container;
    private int[] heights;

    public UnionFindQU_Rank_PathCompression(int capacity) {
        if (capacity < 0) {
